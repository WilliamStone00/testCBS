...
namespace CBS.BusinessService.Accounting
{
    public class NotificationHub:Hub
    {
        ...
        public NotificationHub(IAccountingEntryServices accountingEntryServices, IBranchServices branchServices, IUserManagementServices userServices)
        {
        ...
        public async Task GetUserNotificationRequest()
        {
            try
            {
                ...
                Clients.Caller.SendAsync("ReceiveNotifications", notifications);
            }
            catch (Exception ex)
            {
        ...
        private async Task<List<UsersNotification>> GetUserNotificationRequestFromDB()
        {
            try
            {
