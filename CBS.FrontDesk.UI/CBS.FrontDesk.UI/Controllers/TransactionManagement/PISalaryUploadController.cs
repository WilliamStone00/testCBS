...
namespace CBS.FrontDesk.UI.Controllers.TransactionManagement
{
    ...
    public class PISalaryUploadController : BaseController
    {
        ...
        public PISalaryUploadController(SalaryUploadServices salaryUploadServices, SalaryAnalysisResultServices salaryAnalysisResultServices)
        {
            ...
            try
            {
                ...
                if (path == "list")
                {
                    var fileUploads = await _salaryUploadServices.GetUploadDtosAsyncByStatus(
                        new GetAllFileUploadSalaryFileActivatedQuery { Both = true, Status = true }, "pi_salary"
                    );
