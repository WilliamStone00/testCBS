...
namespace CBS.FrontDesk.UI.Controllers.TransactionManagement
{
    ...
    public class SubTellerCashRequisitionController : BaseController
    {
        // GET: SubTellerCashRequisition
        private readonly SubTellerCashReplenishmentServices _services;
        private readonly BranchServices _branchServices;

        public SubTellerCashRequisitionController(SubTellerCashReplenishmentServices services, BranchServices branchServices = null)
        {
            _services = services;
        ...
        {
            var pending = await _services.GetAllApendingSubTellerCashReplenishments();
            return View(pending.ToList());
        }
        //PendingRequest
        public async Task<ActionResult> RequestValidation(string ProvisionKey)
        {
            var cashReplenishmentSub = await _services.GetCashReplenishmentSubTeller(ProvisionKey);
            ...
            cashReplenishmentSub.Approved = true;
            return View(cashReplenishmentSub);
        }
        public async Task<ActionResult> Request()
        {
            return View(new CashReplenishmentSubTeller());
        }
        [HttpPost]
        public async Task<ActionResult> Create(CashReplenishmentSubTeller model)
        {
            if (model.Id == null)
            {
        ...
        [HttpPost]
        public async Task<ActionResult> Update(CashReplenishmentSubTeller model)
        {
