...
namespace CBS.FrontDesk.UI.Controllers.TransactionManagement
{
    ...
    public class SalaryExecutionController : BaseController
    {
        ...
        public SalaryExecutionController(SalaryExecutionServices salaryExecutionServices, SalaryUploadServices salaryUploadServices, IndividualProfileServices individualProfileServices)
        {
