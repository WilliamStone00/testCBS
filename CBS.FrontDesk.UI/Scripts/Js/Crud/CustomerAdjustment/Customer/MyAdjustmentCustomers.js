...
function postMemberAdjustmentRequest(form) {
    ...
    if (!$(form).valid()) {
      ...
      var  confirmMessage = `
        ...
        📝 This action will be <strong>logged</strong> and submitted for approval.<br/><br/>
        <strong>Do you wish to proceed with the adjustment?</strong>`;

        alertify.confirm("Confirmation", confirmMessage,
            function () {
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        ...
                        if (err.status === 401) {
                            ...
                            // alertify.error(err.responseJSON?.message || err.statusText || 'An error occurred');
