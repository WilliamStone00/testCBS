 ...
 */
function LoadDataGeneration(controller, tableID, partialView, datalistingview, KEY, serviceOption, path = 'list') {
    KEY = $("#SystemQuery_ReferenceId").val();
...
function printJournalEntry() {
    var url;
    url = "/Reports/AccountingPDFReport?FileType=JournalEntryReference";
