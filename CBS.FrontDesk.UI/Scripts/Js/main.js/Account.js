$(document).ready(function () {
    ...
    $("#loadAccountsfromChart").click(function () {
        LoadAccountsfromChart();
    });

    $("#loadAccountsfromChartForChart").click(function () {
        loadAccountsfromChartForChart();
    });
});
...
function LoadAccountsfromChart() {
    $.ajax({
...
function loadAccountsfromChartForChart() {
    $.ajax({
        url: "/AccountingChart/InitializeData?KEY=null&partialView=null&path=list",
        success: function (data) {
