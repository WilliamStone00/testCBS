...
function loadBranchAccounts(branchId) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#DailyCollectorxCollectorId').empty();

            // Optional: Add a default "select" option
            $('#DailyCollectorxCollectorId').append($('<option>').text('-- Choose Collector --').attr('value', ''));
            ...
            $.each(data.data, function (index, item) {
                ...
                $('#DailyCollectorxCollectorId').append(option);
            });
        },
    ...
    try {
        ...
        alertify.confirm("COLLECTORS MEMBER UPLOAD", messageStatus,
            function () {
                ...
                $.ajax({
                    url: "/DailyAgentManagement/UploadDailyCollectorModel/",
                    type: "POST",
                    data: formData,
...
//            $.ajax({
//                url: "/DailyAgentManagement/UploadDailyCollectorModel/", // Replace with your actual endpoint
//                type: "POST",
//                data: formData,
//                contentType: false,
//                processData: false,
...
//                    if (response.success) {
//                        appalert("COLLECTORS MEMBER FILE UPLOADED SUCCESSFULLY", 1, 1);
//                        // Optional: Display results or redirect
//                        if (typeof displayResults === 'function') {
...
// Helper function to update progress bar (add this if not already present)
