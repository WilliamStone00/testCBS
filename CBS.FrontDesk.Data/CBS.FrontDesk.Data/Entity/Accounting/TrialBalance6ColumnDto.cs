...
namespace CBS.FrontDesk.Data.Entity.Accounting
{
    ...
    public class TrialBalance6ColumnDto
    {
        ...
        public decimal TotalBeginningDebitBalance { get; set; }
        public decimal TotalBeginningCreditBalance { get; set; }
        public decimal TotalDebitBalance { get; set; }
        public decimal TotalCreditBalance { get; set; }
        public decimal TotalEndDebitBalance { get; set; }
        public decimal TotalEndCreditBalance { get; set; }
    }
